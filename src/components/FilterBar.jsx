        ...
        <div className="flex items-center justify-between gap-4 flex-wrap pb-3.5 border-b border-slate-100">
          ...
          {activeFilterCount > 0 && (
            <button
              ...
              className="inline-flex items-center gap-1 text-xs font-medium text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 px-3 py-1 rounded-full transition-colors cursor-pointer"
            >
